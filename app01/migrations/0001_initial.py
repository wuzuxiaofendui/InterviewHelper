# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-09-21 09:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telephone', models.CharField(blank=True, max_length=11, null=True, unique=True, verbose_name='手机')),
                ('creat_time', models.DateField(auto_now_add=True, verbose_name='创建时间')),
                ('email', models.EmailField(max_length=254, null=True)),
                ('qq', models.CharField(max_length=30, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creat_time', models.DateField(auto_now_add=True, verbose_name='面试日期')),
